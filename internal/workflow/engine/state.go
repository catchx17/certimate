...
const (
	...
	stateVarKeyDeploymentNodeId                        = "deployment.nodeId"                        // ValueType: "string"
	stateVarKeyDeploymentNodeName                      = "deployment.nodeName"                      // ValueType: "string"
	stateVarKeyDeploymentStatus                        = "deployment.status"                        // ValueType: "string"
	stateVarKeyDeploymentSkipped                       = "deployment.skipped"                       // ValueType: "boolean"
	stateVarKeyDeploymentProvider                      = "deployment.provider"                      // ValueType: "string"
	stateVarKeyDeploymentProviderAccessId              = "deployment.providerAccessId"              // ValueType: "string"
	stateVarKeyDeploymentProviderAccessName            = "deployment.providerAccessName"            // ValueType: "string"
	stateVarKeyDeploymentTarget                        = "deployment.target"                        // ValueType: "string"
	stateVarKeyDeploymentTargetType                    = "deployment.targetType"                    // ValueType: "string"
	stateVarKeyDeploymentTargetId                      = "deployment.targetId"                      // ValueType: "string"
	stateVarKeyDeploymentTargetHost                    = "deployment.targetHost"                    // ValueType: "string"
	stateVarKeyDeploymentTargetDomains                 = "deployment.targetDomains"                 // ValueType: "string"
	stateVarKeyDeploymentTargetFiles                   = "deployment.targetFiles"                   // ValueType: "string"
	stateVarKeyDeploymentTargetNames                   = "deployment.targetNames"                   // ValueType: "string"
	stateVarKeyDeploymentTargetPorts                   = "deployment.targetPorts"                   // ValueType: "string"
	stateVarKeyDeploymentCertificateId                 = "deployment.certificateId"                 // ValueType: "string"
	stateVarKeyDeploymentCertificateCommonName         = "deployment.certificateCommonName"         // ValueType: "string"
	stateVarKeyDeploymentCertificateSubjectAltNames    = "deployment.certificateSubjectAltNames"    // ValueType: "string"
)
